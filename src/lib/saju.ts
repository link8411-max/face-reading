...
// 띠별 2025년 기본 운세
export const 띠별운세2025: Record<string, { 총운: number; 키워드: string; 조언: string }> = {
  '쥐': { 총운: 3, 키워드: '신중', 조언: '큰 결정은 하반기로 미루세요' },
  '소': { 총운: 4, 키워드: '성장', 조언: '꾸준한 노력이 결실을 맺습니다' },
  '호랑이': { 총운: 3, 키워드: '인내', 조언: '급하게 서두르지 마세요' },
  '토끼': { 총운: 4, 키워드: '기회', 조언: '새로운 만남에 열린 마음을 가지세요' },
  '용': { 총운: 5, 키워드: '도약', 조언: '올해가 적기입니다, 도전하세요' },
  '뱀': { 총운: 4, 키워드: '본명년', 조언: '자기 관리에 집중하세요' },
  '말': { 총운: 3, 키워드: '안정', 조언: '현재에 충실하세요' },
  '양': { 총운: 4, 키워드: '협력', 조언: '주변의 도움을 받아들이세요' },
  '원숭이': { 총운: 3, 키워드: '절제', 조언: '충동적인 결정을 피하세요' },
  '닭': { 총운: 4, 키워드: '발전', 조언: '자기계발에 투자하세요' },
  '개': { 총운: 3, 키워드: '휴식', 조언: '건강 관리가 우선입니다' },
  '돼지': { 총운: 5, 키워드: '행운', 조언: '적극적으로 움직이세요' },
};
